...
public class BiomeTagPredicate {
	private static final BiomeTagPredicate ANY = new BiomeTagPredicate(MinMaxBounds.Doubles.ANY,
			MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, new ArrayList<>(), new ArrayList<>(), false);
	...
	public BiomeTagPredicate(MinMaxBounds.Doubles x, MinMaxBounds.Doubles y, MinMaxBounds.Doubles z,
			List<TagKey<Biome>> include, List<TagKey<Biome>> exclude, boolean and) {
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public static Set<Holder<Biome>> getValidBiomes(ServerLevel serverLevel, List<TagKey<Biome>> includeList,
			List<TagKey<Biome>> excludeList, boolean and) {
		Set<Holder<Biome>> biomes = new HashSet<>();
		Optional<? extends Registry<Biome>> optionalBiomeRegistry = serverLevel.registryAccess()
	...
	public static class CheckType {
		...
		public boolean equals(Object o) {
			...
			return this.and == checkType.and && Objects.equals(this.include, checkType.include)
					&& Objects.equals(this.exclude, checkType.exclude);
		}
