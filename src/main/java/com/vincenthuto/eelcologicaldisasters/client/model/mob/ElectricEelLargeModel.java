...
public class ElectricEelLargeModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public ElectricEelLargeModel(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.animate(((ElectricEelEntity) entity).idleAnimationState, ElectricEelLargeModel.MODEL_IDLE, ageInTicks);
