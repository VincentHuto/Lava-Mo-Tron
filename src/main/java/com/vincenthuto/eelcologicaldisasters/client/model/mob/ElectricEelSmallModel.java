...
public class ElectricEelSmallModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public ElectricEelSmallModel(ModelPart root) {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.animate(((ElectricEelEntity) entity).idleAnimationState, ElectricEelSmallModel.MODEL_IDLE, ageInTicks);
